// Generated from E:/aya/study/مترجمات/untitled1/src/antlar/htmlParser.g4 by ANTLR 4.13.2
package antlar;
...
public class htmlParser extends Parser {
	...
	public static final int
		...
		STRING=14, IDENTIFIER=15, TEXT=16, WS=17, EXTENDS=18, STRING_J=19, IDENTIFIER_J=20, 
		FOR=21, IN=22, ENDFOR=23, IDENTIFIER_E=24, STRING_E=25, EQ_J=26, DOT=27, 
		STYLE_OPEN=28, CSS_TEXT=29, STYLE_CLOSE=30, VOID_TAG=31, DOCTYPE=32;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"STRING", "IDENTIFIER", "TEXT", "WS", "EXTENDS", "STRING_J", "IDENTIFIER_J", 
			"FOR", "IN", "ENDFOR", "IDENTIFIER_E", "STRING_E", "EQ_J", "DOT", "STYLE_OPEN", 
			"CSS_TEXT", "STYLE_CLOSE", "VOID_TAG", "DOCTYPE"
		};
	}
	...
	public final TemplateContext template() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4563468330L) != 0)) {
				{
				{
				setState(50);
				content();
